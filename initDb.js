...
const { bulkInsertNewPhotos } = require('./models/photo')
const { bulkInsertNewReviews } = require('./models/review')
...
connectToDb(async function () {
     ...
     */
    const businessesIds = await bulkInsertNewBusinesses(businessData)
    const photosIds = await bulkInsertNewPhotos(photosData)
    const reviewsIds = await bulkInsertNewReviews(reviewsData)
    const usersIds = await bulkInsertNewUsers(usersData)
